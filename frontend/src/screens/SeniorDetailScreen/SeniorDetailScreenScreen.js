    ...
    return (
      <View style={styles.view}>
        <ProfileCard
          ...
          email={seniorEmail}
        />
        <Card style={styles.card} onPress={() => navigation.navigate('SeniorBloodPressureList', params)}>
          <Card.Title title="Ciśnienie krwi" right={RightContent} />
        </Card>
        <Card style={styles.card} onPress={() => navigation.navigate('SeniorSugarList', params)}>
          <Card.Title title="Poziom cukru" right={RightContent} />
        </Card>
        <Card style={styles.card} onPress={() => navigation.navigate('SeniorWeightList', params)}>
